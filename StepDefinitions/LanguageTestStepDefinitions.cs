...
namespace MarsSpecFlow.StepDefinitions
{
    ...
    public class LanguageTestStepDefinitions : Driver
    {
        ...
        public void ThenINavigateToProfilePageAndLanguageTabShoudBeSelected()
        {
        ...
        [Then(@"I create a new langauge records with values  '([^']*)' '([^']*)'")]
        ...
        [Then(@"I create a new langauge records with value  '([^']*)' without adding language level")]
        ...
        [Then(@"I Edit an existing language '([^']*)'to a new langauge record with value '([^']*)' without editng language level")]
        ...
        [Then(@"I Edit an existing language '([^']*)' to a new langauge record by editing language level record form '([^']*)' to '([^']*)' without editng language")]
        ...
        [Then(@"I delete existing language Arabic")]
        public void ThenIDeleteExistingLanguageArabic(string language)
        {
